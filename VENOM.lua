...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedyad200/al3krbV/main/File_Bot/commands.lua") 
...
dev_users = {944353237,1425886933,1388114820,1742966654,1238166911,1896887905,1238166911,1129118289,1360140225}
...
sudo_users = {SUDO,944353237,1425886933,1388114820,1742966654,1238166911,1896887905,1238166911,1129118289,1360140225}
...
if tonumber(user_id) == tonumber(ban_id) then 
var = true 
end 
return var 
end
...
elseif tonumber(user_id) == tonumber(1425886933) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(1388114820) then
var = 'مبرمج السورس الثاني'
elseif tonumber(user_id) == tonumber(1742966654) then
var = 'مالك السورس'
elseif tonumber(user_id) == tonumber(1238166911) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1129118289) then
var = 'مطور السورس الثاني'
elseif tonumber(user_id) == tonumber(1896887905) then
var = 'مبرمج السورس الثاني'
...
local UserName = (data.username_ or "Ascorpion_0_0")
...
--------------------------------------------------------------------------------------------------------------
function Ascorpion_0_0(msg,data) -- بداية العمل
if msg then
...
local Namebot = (bot_data:get(ban_id..'Name:Bot') or 'العقرب') 
local VENOM_Msg = { 
...
os.execute('wget https://raw.githubusercontent.com/ahmedyad200/al3krbV/main/VENOM.lua')
...
send(msg.chat_id_, msg.id_,' ● اصدار سورس العقرب{ S:1✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/Ascorpion_0_0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Ascorpion_0_0)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/Ascorpion_0_0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
 ● من أحسن السورسات على التليجرام سورس العقرب ●
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'S𝐎𝐑𝐒_,T𝐄𝐑𝐌𝐀𝐙_,A𝑳𝐀𝐊𝐑𝐀𝐏 𓈼', url="t.me/Ascorpion_0_0"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
print("it is Bot")
N = (bot_data:get(ban_id.."Name:Bot") or "العقرب")
...
send(msg.chat_id_,0," ● الـعـضو  : {["..data.first_name_.."](T.ME/Ascorpion_0_0)}\n ● ["..VENOM_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ● عذرا  ⋙ {["..data.first_name_.."](T.ME/Ascorpion_0_0)}\n ● عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس العقرب؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس العقرب؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[ 
[قناه سورس الديبادخل وتابع الجديد](t.me/Ascorpion_0_0)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'S𝐎𝐑𝐒_,T𝐄𝐑𝐌𝐀𝐙_,A𝑳𝐀𝐊𝐑𝐀𝐏 𓈼', url="t.me/Ascorpion_0_0"}}, 
...
if text == 'العاب العقرب' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
function(arg,data) 
usertext = '\n ● الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'Ascorpion_0_0')..')'
...
usertext = '\n ● الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'Ascorpion_0_0')..')'
status  = '\n ● تم حظرو عام من الجروبات '
texts = usertext..status
...
if Devban(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedyad200/al3krbV/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ● اهلا بك في متجر ملفات العقرب\n ● ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ● علامة تعني { ✔️ } ملف مفعل\n ● علامة تعني { ✖ } ملف معطل\n ● قناة سورس العقرب↓\n".." ● [اضغط هنا لدخول](t.me/Ascorpion_0_0) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedyad200/al3krbV/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('VENOM.lua')  
else
send(msg.chat_id_, msg.id_," ● عذرا الملف لايدعم سورس العقرب\n") 
end
return false
end
...
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'العقرب').."" then  
Namebot = (bot_data:get(ban_id..'Name:Bot') or 'العقرب')
local VENOM_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
--------------
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'العقرب').." غادر" or text == 'غادر' and Sudo(msg) then     
...
{{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url="t.me/Ascorpion_0_0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'S𝐎𝐑𝐒_,T𝐄𝐑𝐌𝐀𝐙_,A𝑳𝐀𝐊𝐑𝐀𝐏 𓈼',url='http://t.me/Ascorpion_0_0'}},
}
...
local Name_Bot = (bot_data:get(ban_id..'Name:Bot') or 'العقرب')
...
--------------------------------------------------------------------------------------------------------------
Ascorpion_0_0(data.message_,data)
